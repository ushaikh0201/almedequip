...
/***/ "./common/environments/environment.ts":
/*!********************************************!*\
  !*** ./common/environments/environment.ts ***!
  \********************************************/
...
/* harmony import */ var _environments_environment__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../environments/environment */ "./common/environments/environment.ts");
...
var CustomHttp = /** @class */ (function (_super) {
    ...
    CustomHttp.prototype.get = function (url, options) {
        return _super.prototype.get.call(this, _environments_environment__WEBPACK_IMPORTED_MODULE_2__["environment"].apiUrl + url, this.addJwt(options)).catch(this.handleError);
    };
    CustomHttp.prototype.post = function (url, body, options) {
        return _super.prototype.post.call(this, _environments_environment__WEBPACK_IMPORTED_MODULE_2__["environment"].apiUrl + url, body, this.addJwt(options)).catch(this.handleError);
    };
    CustomHttp.prototype.put = function (url, body, options) {
        return _super.prototype.put.call(this, _environments_environment__WEBPACK_IMPORTED_MODULE_2__["environment"].apiUrl + url, body, this.addJwt(options)).catch(this.handleError);
    };
    CustomHttp.prototype.delete = function (url, options) {
        return _super.prototype.delete.call(this, _environments_environment__WEBPACK_IMPORTED_MODULE_2__["environment"].apiUrl + url, this.addJwt(options)).catch(this.handleError);
    };
    ...
    CustomHttp.prototype.addJwt = function (options) {
        ...
        var currentUser = JSON.parse(localStorage.getItem('loggedInGeneralUser'));
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _custom_http__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./custom-http */ "./common/helpers/custom-http.ts");
...
/* harmony import */ var _common_helpers_index__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ../../common/helpers/index */ "./common/helpers/index.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
    ...
    AppModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_3__["NgModule"])({
            ...
            providers: [
                ...
                _common_helpers_index__WEBPACK_IMPORTED_MODULE_11__["customHttpProvider"]
            ],
        })
    ], AppModule);
    return AppModule;
...
module.exports = __webpack_require__(/*! /home/ushaikh/ushaikh/projects/almedequip/admin/src/main.ts */"./src/main.ts");
